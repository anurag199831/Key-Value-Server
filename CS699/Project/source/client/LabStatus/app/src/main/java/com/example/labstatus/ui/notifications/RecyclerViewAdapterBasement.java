...
public class RecyclerViewAdapterBasement extends RecyclerView.Adapter<RecyclerViewAdapterBasement.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void setData(NotificationsViewModel item) {
            try {
                this.item = item;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        try {
            NotificationsViewModel temp = (NotificationsViewModel) mValues.get(position);
            if (temp.text == "") {
...
*/
    ...
    public interface ItemListener {
        void onItemClick(NotificationsViewModel item);
    }
}
